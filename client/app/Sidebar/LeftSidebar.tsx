  ...
  return (
    ...
    <aside className="flex h-screen w-56 flex-col items-center border-r-2 border-main/20 bg-white py-8 px-4">
      ...
      <div className="flex flex-col items-center gap-1 mb-8">
        <span className="text-lg font-bold text-main">BrokeMeal</span>
      </div>
      ...
      {user.isGuest ? (
        ...
        <div className="flex w-full flex-col items-center gap-3 mt-6">
          <Link
            href="/signup"
            className="w-full rounded-full bg-main py-2.5 text-center text-sm font-medium text-white hover:bg-secondary-dark"
          >
            Sign up
          </Link>
        ...
        <div className="flex w-full flex-col gap-3 mt-6">
          ...
          <button
            onClick={onLogout}
            className="rounded-full bg-main py-2.5 text-center text-sm font-medium text-white hover:bg-secondary-dark"
          >
            Logout
          </button>
        </div>
